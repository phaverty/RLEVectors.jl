...
# searchsortedfirst
@test searchsortedfirst( [3, 6, 9, 12, 15 ], 6, 1, 5 ) == 2
@test searchsortedfirst( [3, 6, 9, 12, 15 ], 7, 1, 5 ) == 3
@test searchsortedfirst( [3, 6, 9, 12, 15 ], 7, 0, 22 ) == 3
@test searchsortedfirst( [3, 6, 9, 12, 15 ], 40, 1, 5 ) == 6
@test searchsortedfirst( [3, 6, 9, 12, 15 ], -2, 1, 5 ) == 1
@test searchsortedfirst( [3, 6, 9, 12, 15 ], 14, 4, 5 ) == 5
@test searchsortedfirst( [3, 6, 9, 12, 15 ], 3, 4, 5 ) == 4
