...
@testset begin
    ...
    @test ree(["a", "b", "c", "d", "d", "e", "f", "g"], [3, 6, 9, 12, 15, 18, 21, 24]) ==
          (["a", "b", "c", "d", "e", "f", "g"], [3, 6, 9, 15, 18, 21, 24]) # Run of 2 runvalues
    @test ree(["a", "b", "c", "d", "d", "d", "e", "f"], [3, 6, 9, 12, 15, 18, 21, 24]) ==
          (["a", "b", "c", "d", "e", "f"], [3, 6, 9, 18, 21, 24]) # Run of 3 runvalues
    @test ree(["a", "b", "c", "d", "e", "f", "g"], [3, 6, 9, 12, 12, 15, 17]) ==
          (["a", "b", "c", "d", "f", "g"], [3, 6, 9, 12, 15, 17]) # run of 2 runends
    @test ree(["a", "b", "c", "d", "e", "f"], [3, 6, 12, 12, 12, 15]) ==
          (["a", "b", "c", "f"], [3, 6, 12, 15]) # run of 3 runends
